...
public class MyMedicalRecordController {
	 ...
	 */
	@GetMapping("")
	public String getCitizenRecords(Model model) {
		model.addAttribute("message", "");
		
		if(model.containsAttribute("myCitizen")) {			
			Citizen myCitizen = (Citizen) model.getAttribute("myCitizen");
			String citizenId = myCitizen.getId();
